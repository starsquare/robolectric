...
public class ShadowApplicationPackageManager extends ShadowPackageManager {
  ...
  @Implementation
  protected Drawable getActivityBanner(ComponentName activityName) {
    return null;
  }

  @Implementation
  protected Drawable getActivityBanner(Intent intent) {
    return null;
  }
  ...
  @Implementation
  protected Drawable getApplicationBanner(String packageName) {
    return null;
  }

  @Implementation
  protected Drawable getActivityLogo(ComponentName activityName) {
    return null;
  }

  @Implementation
  protected Drawable getActivityLogo(Intent intent) {
    return null;
  }
  ...
  @Implementation
  protected Drawable getApplicationLogo(String packageName) {
    return null;
  }
